<?php ini_set('display_errors', 1);  error_reporting(E_ALL); include("header.php"); ?>
        ...
        <div class="col-md-6 col-md-push-3" >
            <article>
                ...
                <div class="articleInner">
                    <form class="form-inline" name="Registreer" >
                        ...
                        <center><input type="button" value="Verstuur" onclick="validateForm()" class="btn btn-success knopAanmeldenPakket"></center>
                    </form>
                    <div id="Comment"></div>
                </div>
            </article>
