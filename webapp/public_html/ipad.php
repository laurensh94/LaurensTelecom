                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-10 col-md-offset-1">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                    <?php
                                    $query = "SELECT * FROM Artikel WHERE Merk = 'Apple' AND Categorie = 2";
                                    ...
                                    if ($result->num_rows === 0) {
                                        if (mysqli_error($link)) {
                                            ...
                                            echo "<p> Op dit moment zijn er geen iPads aanwezig. Houd de website in de gaten voor nieuwe iPads.</p>";
                                        }
                                    } ?>
                                    ...
                                    <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                        <tr>
                                            <td class="col-sm-8 col-md-6">
                                                <div class="media">
                                                    <?php echo "<img class='foto' src= '" . $row['Afbeelding'] . "' alt='iPad'><br>"; ?>
                                                    </a>
